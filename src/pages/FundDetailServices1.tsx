...
const FundDetailServices1: FunctionComponent = () => {
  ...
  const onCompanyProfileContainer1Click = useCallback(() => {
  ...
  return (
    <div className={styles.fundDetailServices1}>
      <div
      ...
      <div
        className={styles.companyProfile1}
        onClick={onCompanyProfileContainer1Click}
      >
        <img className={styles.bgIcon} alt="" src="/bg1.svg" />
        <img
          className={styles.iconMetroExpandMore}
      ...
      <img
        className={styles.component20937}
        alt=""
        src="/component-209--47.svg"
      />
      <div className={styles.fundDetailServices1Inner}>
        <div className={styles.leftNavClosedWrapper}>
          <img
      ...
      <div className={styles.fundDetailServices1Child} />
