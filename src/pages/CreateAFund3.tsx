...
import styles from "./CreateAFund3.module.css";
const CreateAFund3: FunctionComponent = () => {
  ...
  return (
    <div className={styles.createAFund3}>
      ...
      <div className={styles.bgContainer}>
        ...
        <div className={styles.component212127}>
          <div className={styles.buttonNormal}>
            <div className={styles.buttonNormalChild} />
      ...
      <div className={styles.createAFund3Child} />
      ...
      <img
        className={styles.component20961}
        alt=""
        src="/component-209--47.svg"
      />
      <div className={styles.createAFund3Inner}>
      ...
      <div className={styles.createAFund3Item} />
      <div className={styles.groupContainer}>
        ...
        <div className={styles.logoParent}>
          <div className={styles.logo1}>04 of 06</div>
        ...
        <div className={styles.descriptionOfInvestment}>
          Description of Investment highlights and rationale​
        </div>
        <div className={styles.descriptionOfKey}>
          Description of Key performance indicators (KPIs) and progress updates​
        </div>
        <div className={styles.descriptionOfExits}>
          Description of Exits and realized returns, if applicable​
        </div>
        <div
        ...
        <div className={styles.label9}>
          ...
          <div className={styles.healthPlusInc}>Health Plus Inc.</div>
        </div>
        <div className={styles.labelParent}>
          <div className={styles.buttonNormal}>
            <div className={styles.companyName}>Investment Strategy</div>
            <img className={styles.path297Icon} alt="" src="/path-297.svg" />
            <div className={styles.healthPlusInc}>Venture Capital</div>
          </div>
        ...
        <div className={styles.labelGroup}>
          <div className={styles.buttonNormal}>
            <div className={styles.companyName}>Target Industry/Sector</div>
            <img className={styles.path297Icon} alt="" src="/path-297.svg" />
            <div className={styles.healthPlusInc}>Healthcare</div>
          </div>
          <div className={styles.iconNavigationArrowDropDow}>
            <div className={styles.buttonNormal} />
            <img className={styles.colorIcon} alt="" src="/-color1.svg" />
        ...
        <div className={styles.label12}>
          <div className={styles.companyName}>Year Founded</div>
          <img className={styles.path297Icon} alt="" src="/path-297.svg" />
      ...
      <div className={styles.createAFund3Inner1}>
        <div className={styles.addCompanyParent}>
          <div className={styles.addCompany}>Add Company</div>
          <img
