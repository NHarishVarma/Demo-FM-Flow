...
import styles from "./CreateAFund5.module.css";
const CreateAFund5: FunctionComponent = () => {
  ...
  return (
    <div className={styles.createAFund5}>
      ...
      <div className={styles.bgContainer}>
        ...
        <div className={styles.component212159}>
          <div className={styles.buttonNormal}>
            <div className={styles.buttonNormalChild} />
      ...
      <div className={styles.createAFund5Child} />
      ...
      <img
        className={styles.component20963}
        alt=""
        src="/component-209--47.svg"
      />
      <div className={styles.createAFund5Inner}>
      ...
      <div className={styles.createAFund5Item} />
      <div className={styles.groupContainer}>
        <div className={styles.buttonNormal}>
          ...
          <div className={styles.label9}>
            <div className={styles.managementFees}>Management Fees</div>
            <img className={styles.path297Icon} alt="" src="/path-297.svg" />
            <div className={styles.div1}>—</div>
          </div>
          <div className={styles.label10}>
            <div className={styles.managementFees}>
              Additional Fess and Expenses
            </div>
            <img className={styles.path297Icon} alt="" src="/path-297.svg" />
            <div className={styles.div1}>—</div>
          </div>
        </div>
        <b className={styles.feesAndExpenses}>Fees and Expenses</b>
        <b className={styles.logo}>Create a Fund</b>
        <div className={styles.logoParent}>
          <div className={styles.logo1}>06 of 06</div>
      ...
      <div className={styles.groupParent1} onClick={onGroupContainer36Click}>
        <img className={styles.groupChild1} alt="" src="/group-17547.svg" />
        <div className={styles.next}>Next</div>
      </div>
      <div className={styles.groupParent2} onClick={onGroupContainer37Click}>
        <img className={styles.groupChild2} alt="" src="/group-175471.svg" />
        <div className={styles.previous}>Previous</div>
      </div>
      <div className={styles.createAFund5Inner1}>
        <div className={styles.addFeesOrExpensesParent}>
          <div className={styles.addFeesOr}>Add Fees or Expenses</div>
          <img
