...
import styles from "./CreateAFund.module.css";
const CreateAFund: FunctionComponent = () => {
  ...
  return (
    <div className={styles.createAFund}>
      ...
      <div className={styles.bgContainer}>
        ...
        <div className={styles.component21279}>
          <div className={styles.buttonNormal}>
            <div className={styles.buttonNormalChild} />
      ...
      <div className={styles.createAFundChild} />
      ...
      <img
        className={styles.component20958}
        alt=""
        src="/component-209--47.svg"
      />
      <div className={styles.createAFundInner}>
      ...
      <div className={styles.createAFundItem} />
      <div className={styles.groupContainer}>
        ...
        <div className={styles.groupFrame}>
          <div className={styles.uploadLogoParent}>
        ...
        <div className={styles.groupWrapper1}>
          <div className={styles.uploadImageParent}>
            <div className={styles.uploadLogo}>Upload Image</div>
            <img
              className={styles.cloudUploadFill0Wght400GraIcon}
              alt=""
              src="/cloud-upload-fill0-wght400-grad0-opsz48.svg"
        ...
        <div className={styles.fundManagerGeneralPartnerParent}>
          <b className={styles.fundManager2}>
      ...
      <div className={styles.groupParent1} onClick={onGroupContainer46Click}>
