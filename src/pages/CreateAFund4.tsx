...
import styles from "./CreateAFund4.module.css";
const CreateAFund4: FunctionComponent = () => {
  ...
  const onButtonNormalContainer16Click = useCallback(() => {
    navigate("/create-a-fund-5");
  }, [navigate]);

  const onGroupContainer50Click = useCallback(() => {
    navigate("/create-a-fund-5");
  }, [navigate]);

  const onGroupContainer51Click = useCallback(() => {
    navigate("/create-a-fund-3");
  }, [navigate]);

  return (
    <div className={styles.createAFund4}>
      ...
      <div className={styles.bgContainer}>
        ...
        <div className={styles.component212143}>
          <div className={styles.buttonNormal}>
            <div className={styles.buttonNormalChild} />
      ...
      <div className={styles.createAFund4Child} />
      ...
      <img
        className={styles.component20962}
        alt=""
        src="/component-209--47.svg"
      />
      <div className={styles.createAFund4Inner}>
      ...
      <div className={styles.createAFund4Item} />
      <div className={styles.groupContainer}>
        ...
        <b className={styles.legalAndCompliance}>Legal and Compliance</b>
        <b className={styles.logo}>Create a Fund</b>
        <img className={styles.path493Icon} alt="" src="/path-493.svg" />
        <img className={styles.path497Icon} alt="" src="/path-493.svg" />
        <img className={styles.path498Icon} alt="" src="/path-493.svg" />
        <div className={styles.logoParent}>
          <div className={styles.logo1}>05 of 06</div>
        ...
        <div className={styles.labelParent}>
          <div className={styles.buttonNormal}>
            <div className={styles.offeringDocument}>Offering Document</div>
            <img className={styles.path297Icon} alt="" src="/path-297.svg" />
            <div className={styles.privatePlacementMemorandum}>
        ...
        <div className={styles.labelGroup}>
          <div className={styles.buttonNormal}>
            <div className={styles.offeringDocument}>Subscription Document</div>
            <img className={styles.path297Icon} alt="" src="/path-297.svg" />
            <div className={styles.privatePlacementMemorandum}>
        ...
        <div className={styles.labelContainer}>
          <div className={styles.buttonNormal}>
            <div className={styles.offeringDocument}>
              Compliance Requirement and Disclosure
            </div>
            <img className={styles.path297Icon} alt="" src="/path-297.svg" />
            <div className={styles.privatePlacementMemorandum}>KYC</div>
          </div>
          <div className={styles.iconNavigationArrowDropDow}>
            <div className={styles.buttonNormal} />
            <img className={styles.colorIcon} alt="" src="/-color1.svg" />
        ...
        <div className={styles.groupFrame}>
          <div className={styles.addDocumentParent}>
            <div className={styles.addDocument}>Add Document</div>
            <img
      ...
      <div className={styles.groupParent1} onClick={onGroupContainer50Click}>
        <img className={styles.groupChild1} alt="" src="/group-17547.svg" />
        <div className={styles.next}>Next</div>
      </div>
      <div className={styles.groupParent2} onClick={onGroupContainer51Click}>
        <img className={styles.groupChild2} alt="" src="/group-175471.svg" />
