...
const FundDetail1: FunctionComponent = () => {
  ...
  const onRectangle32Click = useCallback(() => {
    navigate("/fund-detail-look-feel-01");
  }, [navigate]);
    ...
    <div className={styles.fundDetail1}>
      ...
      <div className={styles.rectangleParent1}>
        ...
        <div className={styles.scrollGroup13}>
          ...
          <img className={styles.path455Icon1} alt="" src="/path-467.svg" />
          <div className={styles.reneeWilliams1}>Renee Williams</div>
          <img className={styles.path455Icon2} alt="" src="/path-467.svg" />
          <div className={styles.steeleAndersen}>Steele Andersen</div>
          <img className={styles.path455Icon3} alt="" src="/path-467.svg" />
          <div className={styles.steeleAndersen1}>Steele Andersen</div>
          <img className={styles.path455Icon4} alt="" src="/path-467.svg" />
          <div className={styles.reneeWilliams2}>Renee Williams</div>
          <img className={styles.path455Icon5} alt="" src="/path-467.svg" />
          ...
          <img className={styles.path455Icon7} alt="" src="/path-475.svg" />
          <div className={styles.hecklerLlp}>Heckler LLP</div>
          <img className={styles.path455Icon8} alt="" src="/path-475.svg" />
          <div className={styles.hecklerLlp1}>Heckler LLP</div>
          <img className={styles.path455Icon9} alt="" src="/path-475.svg" />
          <div className={styles.alfredTigTrust}>Alfred Tig Trust</div>
          <img className={styles.path455Icon10} alt="" src="/path-475.svg" />
          <div className={styles.alfredTigTrust1}>Alfred Tig Trust</div>
          <img className={styles.path455Icon11} alt="" src="/path-475.svg" />
          <div className={styles.montgomeryWill}>Montgomery Will…</div>
          <img className={styles.path455Icon12} alt="" src="/path-475.svg" />
      ...
      <div className={styles.fundDetail1Inner}>
        <div className={styles.maskGroup35Parent}>
          ...
          <div className={styles.scrollGroup131}>
            ...
            <img className={styles.path455Icon14} alt="" src="/path-455.svg" />
            <img className={styles.path455Icon15} alt="" src="/path-455.svg" />
            <img className={styles.path455Icon16} alt="" src="/path-455.svg" />
            <img className={styles.path455Icon17} alt="" src="/path-455.svg" />
            <img className={styles.path455Icon18} alt="" src="/path-4551.svg" />
            <img className={styles.path473Icon} alt="" src="/path-4552.svg" />
            <img className={styles.path455Icon20} alt="" src="/path-4552.svg" />
            <img className={styles.path455Icon21} alt="" src="/path-4552.svg" />
            <img className={styles.path455Icon22} alt="" src="/path-4552.svg" />
            <img className={styles.path455Icon23} alt="" src="/path-4553.svg" />
            <img className={styles.path455Icon24} alt="" src="/path-4552.svg" />
            <img className={styles.path455Icon25} alt="" src="/path-4553.svg" />
      ...
      <div className={styles.rectangleParent12}>
        ...
        <div className={styles.tabNavButton1} onClick={onTabNavButton7Click}>
          <div className={styles.tabNavButtonItem} />
          <div className={styles.rectangleGroup}>
            <div className={styles.groupInner} />
            <div className={styles.performance}>PERForMANCE</div>
      ...
      <div className={styles.editSaveButton} onClick={onEditSaveButtonClick}>
        <div
          className={styles.editSaveButtonChild}
          onClick={onRectangle32Click}
        />
      ...
      <div className={styles.navbarbgParent}>
        ...
        <div className={styles.groupParent1}>
          <img className={styles.groupChild44} alt="" src="/group-330.svg" />
          <div className={styles.maskGroup35Parent}>
            <div className={styles.maskGroup35Parent}>
      ...
      <div className={styles.list}>
        <div className={styles.div60}>
          <div className={styles.maskGroup35Parent}>
            ...
            <div className={styles.lightDevider}>
              <div className={styles.deviderLight} />
            </div>
            <div className={styles.iconActionFavorite24px}>
              <div className={styles.maskGroup35Parent} />
